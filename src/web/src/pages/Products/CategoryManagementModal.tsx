...
export function CategoryManagementModal({
  ...
  const handleDelete = async () => {
    ...
    setIsLoading(true);
    try {
      await categoriesApi.delete(String(categoryToDelete.id));
                ...
                categories.map((category) => (
                  <CategoryRow key={category.id}>
                    ...
                    <RowActions>
                      ...
                      <IconButton $variant="danger" onClick={() => setCategoryToDelete(category)}>
                        <Trash2 size={14} />
                      </IconButton>
                    </RowActions>
                  </CategoryRow>
